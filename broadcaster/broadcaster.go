...
type BroadcastFeedMessage struct {
	SequenceNumber fogutil.MessageIndex         `json:"sequenceNumber"`
	Message        fogstate.MessageWithMetadata `json:"message"`
...
func (b *Broadcaster) NewBroadcastFeedMessage(message fogstate.MessageWithMetadata, sequenceNumber fogutil.MessageIndex) (*BroadcastFeedMessage, error) {
...
func (b *Broadcaster) BroadcastSingle(msg fogstate.MessageWithMetadata, seq fogutil.MessageIndex) error {
	defer func() {
		if r := recover(); r != nil {
...
func (b *Broadcaster) Confirm(seq fogutil.MessageIndex) {
