...
func createfogMachine(ctx context.Context, locator *server_common.MachineLocator, config *fogitratorMachineConfig, moduleRoot common.Hash) (*fogMachines, error) {
	...
	log.Info("creating fogr machine", "binpath", binPath)
	baseMachine := C.fogitrator_load_wavm_binary(cBinPath)
	if baseMachine == nil {
