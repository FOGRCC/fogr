...
type ExecServerAPI struct {
	...
	config server_fog.fogitratorSpawnerConfigFecher
...
func NewExecutionServerAPI(valSpawner validator.ValidationSpawner, execution validator.ExecutionSpawner, config server_fog.fogitratorSpawnerConfigFecher) *ExecServerAPI {
