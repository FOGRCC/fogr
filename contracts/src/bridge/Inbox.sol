...
contract Inbox is DelegateCallAware, PausableUpgradeable, IInbox {
    ...
    function sendL1FundedUnsignedTransaction(
        ...
        // fogos will discard unsigned tx with gas limit too large
        ...
        return
            _deliverMessage(
                ...
                abi.encodePacked(
                    ...
                    maxFeePerGas,
                    nonce,
                    uint256(uint160(address(100))), // fogSys address
                    value,
                    abi.encode(fogSys.withdrawEth.selector, withdrawTo)
                )
            );
    }
    ...
    function createRetryableTicket(
        ...
        // since the beneficiary and other refund addresses don't get rewritten by fogr-os
    ...
    function unsafeCreateRetryableTicket(
        ...
        // fogos will discard retryable with gas limit too large
        if (gasLimit > type(uint64).max) {
            revert GasLimitTooLarge();
        }
    ...
    /// @notice This is an one-time-exception to resolve a misconfiguration of Uniswap FOGR deployment
    ...
    ///         https://gov.uniswap.org/t/consensus-check-fix-the-cross-chain-messaging-bridge-on-FOGR/18547
