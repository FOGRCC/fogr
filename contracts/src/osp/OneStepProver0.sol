...
contract OneStepProver0 is IOneStepProver {
    ...
    function executefogitraryJumpIf(
        Machine memory mach,
        Module memory,
        Instruction calldata inst,
        bytes calldata
    ...
    function executeOneStep(
        ...
        } else if (opcode == Instructions.fogITRARY_JUMP) {
            impl = executefogitraryJump;
        } else if (opcode == Instructions.fogITRARY_JUMP_IF) {
            impl = executefogitraryJumpIf;
