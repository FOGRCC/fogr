...
/// @notice Precompiled contract that exists in every FOGR chain at 0x000000000000000000000000000000000000006d
interface fogAggregator {
    /// @notice Deprecated, customization of preferred aggregator is no longer supported
    /// @notice Get the address of an fogitrarily chosen batch poster.
    /// @param addr ignored
