...
/**
 * @title This precompile represents fogOS's internal actions as calls it makes to itself
 * @notice Calling this precompile will always revert and should not be done.
 */
interface fogosActs {
    /**
     * @notice fogOS "calls" this when starting a block
