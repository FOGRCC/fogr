 ...
 * @notice Precompiled contract in every FOGR chain for retryable transaction related data retrieval and interactions. Exists at 0x000000000000000000000000000000000000006e
 */
interface fogRetryableTx {
    /**
     ...
     * @param ticketId unique identifier of retryable message: keccak256(keccak256(fogchainId, inbox-sequence-number), uint(0) )
    ...
    /// @dev DEPRECATED in favour of new RedeemScheduled event after the fogr upgrade
