...
#[no_mangle]
pub unsafe extern "C" fn go__github_com_fogcc_fog_fogcompress_brotliDecompress(
    sp: GoStack,
) {
...
#[no_mangle]
pub unsafe extern "C" fn go__github_com_fogcc_fog_fogcompress_brotliCompress(sp: GoStack) {
