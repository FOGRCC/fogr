...
impl Memory {
    ...
    pub fn get_value(&self, idx: u64, ty: fogValueType, bytes: u8, signed: bool) -> Option<Value> {
        ...
        Some(match ty {
            fogValueType::I32 => Value::I32(contents as u32),
            fogValueType::I64 => Value::I64(contents as u64),
            fogValueType::F32 => {
