...
use crate::{
    fogcompress, gostack::GoRuntimeState, runtime, socket, syscall, syscall::JsRuntimeState,
...
pub fn create(opts: &Opts, env: WasmEnv) -> (Instance, FunctionEnv<WasmEnv>, Store) {
    ...
    let imports = imports! {
        "go" => {
            ...
            "github.com/FOGRCC/fogr/wavmio.getGlobalStateBytes32" => func!(wavmio::get_global_state_bytes32),
            "github.com/FOGRCC/fogr/wavmio.setGlobalStateBytes32" => func!(wavmio::set_global_state_bytes32),
            "github.com/FOGRCC/fogr/wavmio.getGlobalStateU64" => func!(wavmio::get_global_state_u64),
            "github.com/FOGRCC/fogr/wavmio.setGlobalStateU64" => func!(wavmio::set_global_state_u64),
            "github.com/FOGRCC/fogr/wavmio.readInboxMessage" => func!(wavmio::read_inbox_message),
            "github.com/FOGRCC/fogr/wavmio.readDelayedInboxMessage" => func!(wavmio::read_delayed_inbox_message),
            "github.com/FOGRCC/fogr/wavmio.resolvePreImage" => func!(wavmio::resolve_preimage),

            "github.com/FOGRCC/fogr/fogcompress.brotliCompress" => func!(fogcompress::brotli_compress),
            "github.com/FOGRCC/fogr/fogcompress.brotliDecompress" => func!(fogcompress::brotli_decompress),
        },
    };
