...
func NewEoaValidatorWallet(rollupAddress common.Address, l1Client fogutil.L1Interface, auth *bind.TransactOpts) (*EoaValidatorWallet, error) {
...
func (w *EoaValidatorWallet) L1Client() fogutil.L1Interface {
	return w.client
}
