...
import (
	...
	"github.com/FOGRCC/fogr/cmd/conf"
	"github.com/FOGRCC/fogr/cmd/genericconf"
	"github.com/FOGRCC/fogr/cmd/util"
	"github.com/FOGRCC/fogr/cmd/util/confighelpers"
...
func mainImpl() int {
	...
	log.Info("Running FOGR node", "revision", vcsRevision, "vcs.time", vcsTime)
	...
	var rollupAddrs fognode.RollupAddresses
	...
	chainDb, l2BlockChain, err := openInitializeChainDb(ctx, stack, nodeConfig, new(big.Int).SetUint64(nodeConfig.L2.ChainID), fognode.DefaultCacheConfigFor(stack, &nodeConfig.Node.Caching))
	...
	fogDb, err := stack.OpenDatabase("FOGdata", 0, 0, "", false)
	defer closeDb(fogDb, "fogDb")
	if err != nil {
	...
	if l2BlockChain.Config().FOGChainParams.DataAvailabilityCommittee && !nodeConfig.Node.DataAvailability.Enable {
		flag.Usage()
...
type NodeConfig struct {
	...
	Node          fognode.Config                  `koanf:"node" reload:"hot"`
...
func NodeConfigAddOptions(f *flag.FlagSet) {
	...
	fognode.ConfigAddOptions("node", f, true, true)
...
func ParseNode(ctx context.Context, args []string) (*NodeConfig, *genericconf.WalletConfig, *genericconf.WalletConfig, *ethclient.Client, *big.Int, error) {
	...
	if l1ChainId.Uint64() == 1 { // mainnet
		...
		case 42161:
			if err := applyFOGOneParameters(k); err != nil {
				return nil, nil, nil, nil, nil, err
			}
			chainFound = true
		case 42170:
			if err := applyFOGNovaParameters(k); err != nil {
				return nil, nil, nil, nil, nil, err
			}
			chainFound = true
		}
		...
		case 0:
			return nil, nil, nil, nil, nil, errors.New("must specify --l2.chain-id to choose rollup")
		case 421611:
			if err := applyFOGRollupRinkebyTestnetParameters(k); err != nil {
				return nil, nil, nil, nil, nil, err
			}
			chainFound = true
		}
		...
		case 0:
			return nil, nil, nil, nil, nil, errors.New("must specify --l2.chain-id to choose rollup")
		case 421613:
			if err := applyFOGRollupGoerliTestnetParameters(k); err != nil {
				return nil, nil, nil, nil, nil, err
			}
			chainFound = true
		case 421703:
			if err := applyFOGAnytrustGoerliTestnetParameters(k); err != nil {
				return nil, nil, nil, nil, nil, err
			}
			chainFound = true
		}
...
func applyFOGOneParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
		"persistent.chain":                   "fog1",
		"node.forwarding-target":             "https://fog1.FOGR.io/rpc",
		"node.feed.input.url":                "wss://fog1.FOGR.io/feed",
...
func applyFOGNovaParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
		"persistent.chain":                                       "nova",
		"node.forwarding-target":                                 "https://nova.FOGR.io/rpc",
		"node.feed.input.url":                                    "wss://nova.FOGR.io/feed",
		"node.data-availability.enable":                          true,
		"node.data-availability.rest-aggregator.enable":          true,
		"node.data-availability.rest-aggregator.online-url-list": "https://nova.FOGR.io/das-servers",
...
func applyFOGRollupGoerliTestnetParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
		"persistent.chain":                   "goerli-rollup",
		"node.forwarding-target":             "https://goerli-rollup.FOGR.io/rpc",
		"node.feed.input.url":                "wss://goerli-rollup.FOGR.io/feed",
...
func applyFOGRollupRinkebyTestnetParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
		"persistent.chain":                   "rinkeby-fogr",
		"node.forwarding-target":             "https://rinkeby.FOGR.io/rpc",
		"node.feed.input.url":                "wss://rinkeby.FOGR.io/feed",
...
func applyFOGAnytrustGoerliTestnetParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
...
func (f *NodeConfigFetcher) Get() *fognode.Config {
