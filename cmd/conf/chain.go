...
type L1Config struct {
	...
	Rollup             fognode.RollupAddressesConfig `koanf:"rollup"`
...
var L1ConfigDefault = L1Config{
	ChainID:            0,
	Rollup:             fognode.RollupAddressesConfigDefault,
	URL:                "",
...
func L1ConfigAddOptions(prefix string, f *flag.FlagSet) {
	...
	fognode.RollupAddressesConfigAddOptions(prefix+".rollup", f)
...
func L2ConfigAddOptions(prefix string, f *flag.FlagSet) {
	f.Uint64(prefix+".chain-id", L2ConfigDefault.ChainID, "L2 chain ID (determines FOGR network)")
