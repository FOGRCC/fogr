...
var (
	clientsCurrentGauge               = metrics.NewRegisteredGauge("fogr/feed/clients/current", nil)
	clientsConnectCount               = metrics.NewRegisteredCounter("fogr/feed/clients/connect", nil)
	clientsDisconnectCount            = metrics.NewRegisteredCounter("fogr/feed/clients/disconnect", nil)
	clientsTotalSuccessCounter        = metrics.NewRegisteredCounter("fogr/feed/clients/success", nil)
	clientsTotalFailedRegisterCounter = metrics.NewRegisteredCounter("fogr/feed/clients/failed/register", nil)
	clientsTotalFailedUpgradeCounter  = metrics.NewRegisteredCounter("fogr/feed/clients/failed/upgrade", nil)
	clientsTotalFailedWorkerCounter   = metrics.NewRegisteredCounter("fogr/feed/clients/failed/worker", nil)
	clientsDurationHistogram          = metrics.NewRegisteredHistogram("fogr/feed/clients/duration", nil, metrics.NewBoundedHistogramSample())
)
...
func (cm *ClientManager) Register(
	conn net.Conn,
	desc *netpoll.Desc,
	requestedSeqNum fogutil.MessageIndex,
	connectingIP net.IP,
	compression bool,
) *ClientConnection {
