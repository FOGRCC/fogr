...
func TestfogAddressTableInit(t *testing.T) {
	evm := newMockEVMForTesting()
	atab := fogAddressTable{}
...
func newMockEVMForTestingWithVersion(version *uint64) *vm.EVM {
	...
	if version != nil {
		chainConfig.FOGChainParams.InitialfogOSVersion = *version
	}
	...
	evm.ProcessingHook = &fogos.TxProcessor{}
	return evm
}
