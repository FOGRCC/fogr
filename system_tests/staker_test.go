...
func makeBackgroundTxs(ctx context.Context, l2info *BlockchainTestInfo, l2clientA fogutil.L1Interface, l2clientB fogutil.L1Interface, faultyStaker bool) error {
...
func stakerTestImpl(t *testing.T, faultyStaker bool, honestStakerInactive bool) {
	...
	l2clientB, l2nodeB := Create2ndNodeWithConfig(t, ctx, l2nodeA, l1stack, l1info, &l2info.fogInitData, fognode.ConfigDefaultL1Test(), nil)
	...
	statelessA, err := staker.NewStatelessBlockValidator(
		...
		l2nodeA.TxStreamer,
		l2nodeA.fogInterface.BlockChain(),
		l2nodeA.ChainDB,
		l2nodeA.fogDB,
		nil,
	...
	statelessB, err := staker.NewStatelessBlockValidator(
		...
		l2nodeB.TxStreamer,
		l2nodeB.fogInterface.BlockChain(),
		l2nodeB.ChainDB,
		l2nodeB.fogDB,
		nil,
		&blockValidatorConfig,
