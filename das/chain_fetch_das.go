...
func NewChainFetchReader(inner fogstate.DataAvailabilityReader, l1client fogutil.L1Interface, seqInboxAddr common.Address) (*ChainFetchReader, error) {
...
func NewChainFetchReaderWithSeqInbox(inner fogstate.DataAvailabilityReader, seqInbox *bridgegen.SequencerInbox) (*ChainFetchReader, error) {
