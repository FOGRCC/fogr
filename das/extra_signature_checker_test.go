...
func (s *StubSignatureCheckDAS) Store(ctx context.Context, message []byte, timeout uint64, sig []byte) (*fogstate.DataAvailabilityCertificate, error) {
...
func (s *StubSignatureCheckDAS) ExpirationPolicy(ctx context.Context) (fogstate.ExpirationPolicy, error) {
