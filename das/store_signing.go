...
var uniquifyingPrefix = []byte("FOGR DAS API Store:")
...
func (s *StoreSigningDAS) Store(ctx context.Context, message []byte, timeout uint64, sig []byte) (*fogstate.DataAvailabilityCertificate, error) {
