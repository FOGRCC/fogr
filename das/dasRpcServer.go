...
var (
	rpcStoreRequestGauge      = metrics.NewRegisteredGauge("fogr/das/rpc/store/requests", nil)
	rpcStoreSuccessGauge      = metrics.NewRegisteredGauge("fogr/das/rpc/store/success", nil)
	rpcStoreFailureGauge      = metrics.NewRegisteredGauge("fogr/das/rpc/store/failure", nil)
	rpcStoreStoredBytesGauge  = metrics.NewRegisteredGauge("fogr/das/rpc/store/bytes", nil)
	rpcStoreDurationHistogram = metrics.NewRegisteredHistogram("fogr/das/rpc/store/duration", nil, metrics.NewBoundedHistogramSample())
)
